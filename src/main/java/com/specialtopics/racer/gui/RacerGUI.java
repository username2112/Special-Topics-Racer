    ...
    public void initalize(RacerDisplay display) {
        ...
        mainBox.setCallback(new GUICallback() {
            ...
            public void onHover() {
                ...
                mainBox.triggerAnimation(new ScaleAnimation<>(200L, Easing.EaseInOutSin, 0.025f));
            }
            ...
            public void onHoverStop() {
                ...
                mainBox.triggerAnimation(new ScaleAnimation<>(200L, Easing.EaseInOutSin, 0f));
            }
        ...
        final TexturedGUIBox creditText = new TexturedGUIBox(buttonX + buttonWidth + 20, buttonY - buttonHeight, 350,
                400, new Texture("com/specialtopics/racer/menu/creditText.png"));
        ...
        creditBox.setCallback(new GUICallback() {
            ...
            public void onHover() {
                ...
                creditBox.triggerAnimation(new ScaleAnimation<>(200L, Easing.EaseInOutSin, 0.025f));
            }
            ...
            public void onHoverStop() {
                ...
                creditBox.triggerAnimation(new ScaleAnimation<>(200L, Easing.EaseInOutSin, 0f));
            }
        ...
        final TexturedGUIBox credit = new TexturedGUIBox(cbuttonX, cbuttonY, cbuttonWidth, cbuttonHeight,
                new Texture("com/specialtopics/racer/menu/credits.png"));
